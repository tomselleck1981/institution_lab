...
2. Run `mofad/scripts/build_catalog.py` from the full local workspace.
3. Publish generated output from `site-testbed/` through the deployment pipeline, not through this source repo.
