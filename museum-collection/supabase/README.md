...
This folder holds the lightweight backend path for a partner museum collection prototype.

## What It Provides

- Staff email/password login through Supabase Auth.
- Staff role/profile table.
- Editable book/catalog record table.
- Subcollection candidate review table for curator-approved groupings.
- Public-safe organization request function.
...
That preserves the static-first principle while still giving staff a real editor.
